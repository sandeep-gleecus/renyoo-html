    ...
    $.widget("wgm.imgNotes", {
        options: {
            ...
            onShow: function(ev, elem) {
                ...
                $('.viewport').append('<div id="hs_media_container">' + $elem.data("note") + '</div>');
                return $('#hs_media_container').position({ my: "top+25", at: "bottom", of: elem, within: '#pod_image', collision: "flipfit" });
            },
